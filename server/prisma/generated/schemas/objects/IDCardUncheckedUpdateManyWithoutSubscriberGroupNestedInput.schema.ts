...
const Schema: z.ZodType<Prisma.IDCardUncheckedUpdateManyWithoutSubscriberGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const IDCardUncheckedUpdateManyWithoutSubscriberGroupNestedInputObjectSchema =
  Schema;
