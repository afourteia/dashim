...
const Schema: z.ZodType<Prisma.FaceUncheckedCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const FaceUncheckedCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
