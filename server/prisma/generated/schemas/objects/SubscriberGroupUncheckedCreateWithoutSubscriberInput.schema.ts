...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutSubscriberInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutSubscriberInputObjectSchema =
  Schema;
