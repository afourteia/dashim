...
const Schema: z.ZodType<Prisma.DeviceTokenCreateNestedManyWithoutDeviceTypeInput> =
  z
    .object({
      create: z
        .union([
...
export const DeviceTokenCreateNestedManyWithoutDeviceTypeInputObjectSchema =
  Schema;
