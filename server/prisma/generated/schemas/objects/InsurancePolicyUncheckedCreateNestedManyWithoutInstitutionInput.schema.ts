...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedCreateNestedManyWithoutInstitutionInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyUncheckedCreateNestedManyWithoutInstitutionInputObjectSchema =
  Schema;
