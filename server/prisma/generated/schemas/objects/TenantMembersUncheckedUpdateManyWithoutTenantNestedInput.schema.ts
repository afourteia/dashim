...
const Schema: z.ZodType<Prisma.TenantMembersUncheckedUpdateManyWithoutTenantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TenantMembersUncheckedUpdateManyWithoutTenantNestedInputObjectSchema =
  Schema;
