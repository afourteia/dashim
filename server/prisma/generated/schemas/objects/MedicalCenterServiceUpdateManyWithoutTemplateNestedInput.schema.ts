...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUpdateManyWithoutTemplateNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterServiceUpdateManyWithoutTemplateNestedInputObjectSchema =
  Schema;
