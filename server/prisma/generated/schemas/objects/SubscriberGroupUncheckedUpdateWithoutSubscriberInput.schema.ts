...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutSubscriberInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutSubscriberInputObjectSchema =
  Schema;
