...
const Schema: z.ZodType<Prisma.MedicalCenterServiceMaxOrderByAggregateInput> = z
  .object({
...
export const MedicalCenterServiceMaxOrderByAggregateInputObjectSchema = Schema;
