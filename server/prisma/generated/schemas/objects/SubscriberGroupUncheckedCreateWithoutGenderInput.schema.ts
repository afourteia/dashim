...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutGenderInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutGenderInputObjectSchema =
  Schema;
