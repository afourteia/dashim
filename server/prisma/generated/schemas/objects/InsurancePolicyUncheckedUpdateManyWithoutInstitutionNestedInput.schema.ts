...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedUpdateManyWithoutInstitutionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InsurancePolicyUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema =
  Schema;
