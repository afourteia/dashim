...
const Schema: z.ZodType<Prisma.TenantUncheckedUpdateWithoutAssignedToInstitutionInput> =
  z
    .object({
      id: z
        .union([
...
export const TenantUncheckedUpdateWithoutAssignedToInstitutionInputObjectSchema =
  Schema;
