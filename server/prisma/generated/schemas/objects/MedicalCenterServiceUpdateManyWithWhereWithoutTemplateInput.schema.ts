...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUpdateManyWithWhereWithoutTemplateInput> =
  z
    .object({
...
export const MedicalCenterServiceUpdateManyWithWhereWithoutTemplateInputObjectSchema =
  Schema;
