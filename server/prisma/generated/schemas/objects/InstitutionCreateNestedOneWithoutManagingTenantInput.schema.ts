...
const Schema: z.ZodType<Prisma.InstitutionCreateNestedOneWithoutManagingTenantInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionCreateNestedOneWithoutManagingTenantInputObjectSchema =
  Schema;
