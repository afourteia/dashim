...
const Schema: z.ZodType<Prisma.IDCardUncheckedCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const IDCardUncheckedCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
