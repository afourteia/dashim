...
const Schema: z.ZodType<Prisma.SubscriberUncheckedCreateNestedManyWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberUncheckedCreateNestedManyWithoutInsurancePolicyInputObjectSchema =
  Schema;
