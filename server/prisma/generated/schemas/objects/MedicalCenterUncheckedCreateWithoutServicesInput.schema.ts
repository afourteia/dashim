...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateWithoutServicesInput> =
  z
    .object({
      id: z.string(),
...
export const MedicalCenterUncheckedCreateWithoutServicesInputObjectSchema =
  Schema;
