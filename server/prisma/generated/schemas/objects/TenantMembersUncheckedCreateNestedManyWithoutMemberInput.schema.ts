...
const Schema: z.ZodType<Prisma.TenantMembersUncheckedCreateNestedManyWithoutMemberInput> =
  z
    .object({
      create: z
        .union([
...
export const TenantMembersUncheckedCreateNestedManyWithoutMemberInputObjectSchema =
  Schema;
