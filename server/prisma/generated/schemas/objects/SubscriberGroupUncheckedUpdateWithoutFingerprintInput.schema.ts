...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutFingerprintInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutFingerprintInputObjectSchema =
  Schema;
