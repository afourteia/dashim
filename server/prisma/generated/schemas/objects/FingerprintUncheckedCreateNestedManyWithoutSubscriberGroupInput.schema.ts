...
const Schema: z.ZodType<Prisma.FingerprintUncheckedCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintUncheckedCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
