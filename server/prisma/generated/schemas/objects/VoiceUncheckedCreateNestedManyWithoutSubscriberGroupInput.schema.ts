...
const Schema: z.ZodType<Prisma.VoiceUncheckedCreateNestedManyWithoutSubscriberGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceUncheckedCreateNestedManyWithoutSubscriberGroupInputObjectSchema =
  Schema;
