...
const Schema: z.ZodType<Prisma.InsurancePolicyUpdateWithoutInstitutionInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const InsurancePolicyUpdateWithoutInstitutionInputObjectSchema = Schema;
