...
const Schema: z.ZodType<Prisma.SubscriberGroupCreateWithoutRelationshipInput> =
  z
    .object({
      id: z.string(),
      ...
      gender: z
        .lazy(
          () => GenderCreateNestedOneWithoutSubscriberGroupInputObjectSchema,
        )
        .optional(),
      subscriber: z.lazy(
      ...
      idCard: z
        .lazy(
          () => IDCardCreateNestedManyWithoutSubscriberGroupInputObjectSchema,
        )
        .optional(),
      face: z
      ...
      voice: z
        .lazy(
          () => VoiceCreateNestedManyWithoutSubscriberGroupInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const SubscriberGroupCreateWithoutRelationshipInputObjectSchema = Schema;
