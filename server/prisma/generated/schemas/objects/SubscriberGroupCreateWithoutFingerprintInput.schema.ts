...
const Schema: z.ZodType<Prisma.SubscriberGroupCreateWithoutFingerprintInput> = z
  .object({
    id: z.string(),
...
export const SubscriberGroupCreateWithoutFingerprintInputObjectSchema = Schema;
