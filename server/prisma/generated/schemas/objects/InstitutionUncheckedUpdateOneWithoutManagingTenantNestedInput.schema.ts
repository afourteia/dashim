...
const Schema: z.ZodType<Prisma.InstitutionUncheckedUpdateOneWithoutManagingTenantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InstitutionUncheckedUpdateOneWithoutManagingTenantNestedInputObjectSchema =
  Schema;
