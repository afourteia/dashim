...
const Schema: z.ZodType<Prisma.MedicalCenterServiceCreateNestedManyWithoutTemplateInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterServiceCreateNestedManyWithoutTemplateInputObjectSchema =
  Schema;
