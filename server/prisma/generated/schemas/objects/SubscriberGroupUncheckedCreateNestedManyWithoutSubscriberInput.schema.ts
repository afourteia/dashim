...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateNestedManyWithoutSubscriberInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUncheckedCreateNestedManyWithoutSubscriberInputObjectSchema =
  Schema;
