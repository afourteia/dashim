...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateManyWithoutRelationshipNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUpdateManyWithoutRelationshipNestedInputObjectSchema =
  Schema;
