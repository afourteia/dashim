...
const Schema: z.ZodType<Prisma.DeviceTokenUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const DeviceTokenUpdateManyWithoutUserNestedInputObjectSchema = Schema;
