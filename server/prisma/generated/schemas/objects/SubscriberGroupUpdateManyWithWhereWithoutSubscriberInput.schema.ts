...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateManyWithWhereWithoutSubscriberInput> =
  z
    .object({
...
export const SubscriberGroupUpdateManyWithWhereWithoutSubscriberInputObjectSchema =
  Schema;
