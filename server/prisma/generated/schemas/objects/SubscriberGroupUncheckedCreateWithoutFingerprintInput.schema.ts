...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutFingerprintInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutFingerprintInputObjectSchema =
  Schema;
