...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateWithoutFingerprintInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    isVoiceVerificationActive: z
      ...
      .optional(),
    gender: z
      .lazy(() => GenderUpdateOneWithoutSubscriberGroupNestedInputObjectSchema)
      .optional(),
    subscriber: z
      .lazy(
        () =>
...
export const SubscriberGroupUpdateWithoutFingerprintInputObjectSchema = Schema;
