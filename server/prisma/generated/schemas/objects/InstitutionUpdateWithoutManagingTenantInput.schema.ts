...
const Schema: z.ZodType<Prisma.InstitutionUpdateWithoutManagingTenantInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    policies: z
      ...
      .optional(),
    members: z
      .lazy(() => SubscriberUpdateManyWithoutInstitutionNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const InstitutionUpdateWithoutManagingTenantInputObjectSchema = Schema;
