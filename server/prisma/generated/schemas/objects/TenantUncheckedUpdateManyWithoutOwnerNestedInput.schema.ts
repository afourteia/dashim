...
const Schema: z.ZodType<Prisma.TenantUncheckedUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => TenantUpsertWithWhereUniqueWithoutOwnerInputObjectSchema,
          ),
          z
            .lazy(
              () => TenantUpsertWithWhereUniqueWithoutOwnerInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => TenantUpdateWithWhereUniqueWithoutOwnerInputObjectSchema,
          ),
          z
            .lazy(
              () => TenantUpdateWithWhereUniqueWithoutOwnerInputObjectSchema,
...
export const TenantUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
