...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateManyWithWhereWithoutGenderInput> =
  z
    .object({
...
export const SubscriberGroupUpdateManyWithWhereWithoutGenderInputObjectSchema =
  Schema;
