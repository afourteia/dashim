...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateWithoutSubscriberInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const SubscriberGroupUpdateWithoutSubscriberInputObjectSchema = Schema;
