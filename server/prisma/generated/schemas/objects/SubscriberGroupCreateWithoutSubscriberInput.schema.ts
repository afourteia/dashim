...
const Schema: z.ZodType<Prisma.SubscriberGroupCreateWithoutSubscriberInput> = z
  .object({
    id: z.string(),
...
export const SubscriberGroupCreateWithoutSubscriberInputObjectSchema = Schema;
