...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateNestedManyWithoutGenderInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUncheckedCreateNestedManyWithoutGenderInputObjectSchema =
  Schema;
