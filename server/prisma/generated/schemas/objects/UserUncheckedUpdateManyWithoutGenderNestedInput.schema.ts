...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutGenderNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          ...
          z
            .lazy(() => UserUpsertWithWhereUniqueWithoutGenderInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          ...
          z
            .lazy(() => UserUpdateWithWhereUniqueWithoutGenderInputObjectSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
...
export const UserUncheckedUpdateManyWithoutGenderNestedInputObjectSchema =
  Schema;
