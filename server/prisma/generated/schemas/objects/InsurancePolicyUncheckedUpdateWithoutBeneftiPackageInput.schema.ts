...
const Schema: z.ZodType<Prisma.InsurancePolicyUncheckedUpdateWithoutBeneftiPackageInput> =
  z
    .object({
      id: z
        .union([
...
export const InsurancePolicyUncheckedUpdateWithoutBeneftiPackageInputObjectSchema =
  Schema;
