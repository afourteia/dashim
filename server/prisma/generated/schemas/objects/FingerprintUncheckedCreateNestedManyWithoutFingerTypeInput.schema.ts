...
const Schema: z.ZodType<Prisma.FingerprintUncheckedCreateNestedManyWithoutFingerTypeInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintUncheckedCreateNestedManyWithoutFingerTypeInputObjectSchema =
  Schema;
