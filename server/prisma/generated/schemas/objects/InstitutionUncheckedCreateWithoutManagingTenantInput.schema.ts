...
const Schema: z.ZodType<Prisma.InstitutionUncheckedCreateWithoutManagingTenantInput> =
  z
    .object({
      id: z.string(),
...
export const InstitutionUncheckedCreateWithoutManagingTenantInputObjectSchema =
  Schema;
