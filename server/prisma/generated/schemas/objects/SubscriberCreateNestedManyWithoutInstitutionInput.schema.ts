...
const Schema: z.ZodType<Prisma.SubscriberCreateNestedManyWithoutInstitutionInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberCreateNestedManyWithoutInstitutionInputObjectSchema =
  Schema;
