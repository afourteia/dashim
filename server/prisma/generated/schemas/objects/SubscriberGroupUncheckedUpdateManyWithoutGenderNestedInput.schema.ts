...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateManyWithoutGenderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUncheckedUpdateManyWithoutGenderNestedInputObjectSchema =
  Schema;
