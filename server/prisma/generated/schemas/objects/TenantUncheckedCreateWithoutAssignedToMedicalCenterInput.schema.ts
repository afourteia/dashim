...
const Schema: z.ZodType<Prisma.TenantUncheckedCreateWithoutAssignedToMedicalCenterInput> =
  z
    .object({
      id: z.string(),
...
export const TenantUncheckedCreateWithoutAssignedToMedicalCenterInputObjectSchema =
  Schema;
