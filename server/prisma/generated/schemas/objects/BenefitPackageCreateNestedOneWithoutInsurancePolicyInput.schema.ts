...
const Schema: z.ZodType<Prisma.BenefitPackageCreateNestedOneWithoutInsurancePolicyInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageCreateNestedOneWithoutInsurancePolicyInputObjectSchema =
  Schema;
