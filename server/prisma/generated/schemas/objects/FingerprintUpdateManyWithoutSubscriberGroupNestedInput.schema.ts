...
const Schema: z.ZodType<Prisma.FingerprintUpdateManyWithoutSubscriberGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintUpdateManyWithoutSubscriberGroupNestedInputObjectSchema =
  Schema;
