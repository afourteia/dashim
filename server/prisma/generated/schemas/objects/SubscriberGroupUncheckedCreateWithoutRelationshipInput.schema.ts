...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateWithoutRelationshipInput> =
  z
    .object({
      id: z.string(),
...
export const SubscriberGroupUncheckedCreateWithoutRelationshipInputObjectSchema =
  Schema;
