...
const Schema: z.ZodType<Prisma.TenantCreateWithoutAssignedToInstitutionInput> =
  z
    .object({
      id: z.string(),
...
export const TenantCreateWithoutAssignedToInstitutionInputObjectSchema = Schema;
