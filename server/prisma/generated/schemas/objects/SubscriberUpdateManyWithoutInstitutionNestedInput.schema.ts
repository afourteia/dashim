...
const Schema: z.ZodType<Prisma.SubscriberUpdateManyWithoutInstitutionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberUpdateManyWithoutInstitutionNestedInputObjectSchema =
  Schema;
