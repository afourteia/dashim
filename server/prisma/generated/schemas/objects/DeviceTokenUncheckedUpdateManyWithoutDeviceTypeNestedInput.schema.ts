...
const Schema: z.ZodType<Prisma.DeviceTokenUncheckedUpdateManyWithoutDeviceTypeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DeviceTokenUncheckedUpdateManyWithoutDeviceTypeNestedInputObjectSchema =
  Schema;
