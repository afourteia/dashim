...
const Schema: z.ZodType<Prisma.MedicalCenterUpdateWithoutServicesInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    managingTenant: z
      .lazy(
        () =>
          TenantUpdateOneRequiredWithoutAssignedToMedicalCenterNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const MedicalCenterUpdateWithoutServicesInputObjectSchema = Schema;
