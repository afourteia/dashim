...
const Schema: z.ZodType<Prisma.TenantUpdateWithoutAssignedToInstitutionInput> =
  z
    .object({
      id: z
        .union([
...
export const TenantUpdateWithoutAssignedToInstitutionInputObjectSchema = Schema;
