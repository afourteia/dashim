...
const Schema: z.ZodType<Prisma.InstitutionCreateWithoutManagingTenantInput> = z
  .object({
    id: z.string(),
    ...
    policies: z
      ...
      .optional(),
    members: z
      .lazy(() => SubscriberCreateNestedManyWithoutInstitutionInputObjectSchema)
      .optional(),
  })
  .strict();

export const InstitutionCreateWithoutManagingTenantInputObjectSchema = Schema;
