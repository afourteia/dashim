...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUncheckedCreateNestedManyWithoutMedicalCenterInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterServiceUncheckedCreateNestedManyWithoutMedicalCenterInputObjectSchema =
  Schema;
