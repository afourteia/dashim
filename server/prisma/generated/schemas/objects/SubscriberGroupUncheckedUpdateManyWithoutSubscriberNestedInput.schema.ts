...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateManyWithoutSubscriberNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUncheckedUpdateManyWithoutSubscriberNestedInputObjectSchema =
  Schema;
