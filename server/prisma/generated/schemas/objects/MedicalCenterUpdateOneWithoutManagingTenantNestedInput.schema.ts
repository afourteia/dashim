...
const Schema: z.ZodType<Prisma.MedicalCenterUpdateOneWithoutManagingTenantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterUpdateOneWithoutManagingTenantNestedInputObjectSchema =
  Schema;
