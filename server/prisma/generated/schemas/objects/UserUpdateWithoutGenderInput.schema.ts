...
import { TenantMembersUpdateManyWithoutMemberNestedInputObjectSchema } from './TenantMembersUpdateManyWithoutMemberNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.UserUpdateWithoutGenderInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    ownerOf: z
      ...
      .optional(),
    memberOf: z
      .lazy(() => TenantMembersUpdateManyWithoutMemberNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const UserUpdateWithoutGenderInputObjectSchema = Schema;
