...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedCreateNestedManyWithoutRelationshipInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberGroupUncheckedCreateNestedManyWithoutRelationshipInputObjectSchema =
  Schema;
