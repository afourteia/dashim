...
const Schema: z.ZodType<Prisma.DeviceTokenUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const DeviceTokenUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
