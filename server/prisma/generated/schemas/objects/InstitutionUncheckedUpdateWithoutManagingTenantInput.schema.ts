...
const Schema: z.ZodType<Prisma.InstitutionUncheckedUpdateWithoutManagingTenantInput> =
  z
    .object({
      id: z
        .union([
      ...
      members: z
        .lazy(
          () =>
            SubscriberUncheckedUpdateManyWithoutInstitutionNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const InstitutionUncheckedUpdateWithoutManagingTenantInputObjectSchema =
  Schema;
