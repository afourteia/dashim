...
const Schema: z.ZodType<Prisma.VoiceUpdateManyWithoutSubscriberGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceUpdateManyWithoutSubscriberGroupNestedInputObjectSchema =
  Schema;
