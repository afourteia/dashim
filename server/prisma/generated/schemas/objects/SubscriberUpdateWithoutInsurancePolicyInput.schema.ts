...
const Schema: z.ZodType<Prisma.SubscriberUpdateWithoutInsurancePolicyInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const SubscriberUpdateWithoutInsurancePolicyInputObjectSchema = Schema;
