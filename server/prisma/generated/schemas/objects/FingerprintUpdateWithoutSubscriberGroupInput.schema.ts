...
const Schema: z.ZodType<Prisma.FingerprintUpdateWithoutSubscriberGroupInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const FingerprintUpdateWithoutSubscriberGroupInputObjectSchema = Schema;
