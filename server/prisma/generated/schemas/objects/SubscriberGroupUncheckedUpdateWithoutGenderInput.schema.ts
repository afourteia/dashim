...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutGenderInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutGenderInputObjectSchema =
  Schema;
