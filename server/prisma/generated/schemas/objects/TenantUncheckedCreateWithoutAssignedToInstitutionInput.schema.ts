...
const Schema: z.ZodType<Prisma.TenantUncheckedCreateWithoutAssignedToInstitutionInput> =
  z
    .object({
      id: z.string(),
...
export const TenantUncheckedCreateWithoutAssignedToInstitutionInputObjectSchema =
  Schema;
