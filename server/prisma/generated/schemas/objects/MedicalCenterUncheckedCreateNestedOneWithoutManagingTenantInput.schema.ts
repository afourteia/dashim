...
const Schema: z.ZodType<Prisma.MedicalCenterUncheckedCreateNestedOneWithoutManagingTenantInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterUncheckedCreateNestedOneWithoutManagingTenantInputObjectSchema =
  Schema;
