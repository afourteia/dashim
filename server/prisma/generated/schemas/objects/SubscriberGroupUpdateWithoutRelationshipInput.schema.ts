...
import { GenderUpdateOneWithoutSubscriberGroupNestedInputObjectSchema } from './GenderUpdateOneWithoutSubscriberGroupNestedInput.schema';
...
const Schema: z.ZodType<Prisma.SubscriberGroupUpdateWithoutRelationshipInput> =
  z
    .object({
      id: z
        .union([
      ...
      gender: z
        .lazy(
          () => GenderUpdateOneWithoutSubscriberGroupNestedInputObjectSchema,
        )
        .optional(),
      subscriber: z
        .lazy(
      ...
      idCard: z
        .lazy(
          () => IDCardUpdateManyWithoutSubscriberGroupNestedInputObjectSchema,
        )
        .optional(),
      face: z
      ...
      voice: z
        .lazy(
          () => VoiceUpdateManyWithoutSubscriberGroupNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const SubscriberGroupUpdateWithoutRelationshipInputObjectSchema = Schema;
