...
const Schema: z.ZodType<Prisma.MedicalCenterServiceUpdateManyWithoutMedicalCenterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MedicalCenterServiceUpdateManyWithoutMedicalCenterNestedInputObjectSchema =
  Schema;
