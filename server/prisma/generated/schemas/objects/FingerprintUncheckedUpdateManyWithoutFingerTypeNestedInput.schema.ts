...
const Schema: z.ZodType<Prisma.FingerprintUncheckedUpdateManyWithoutFingerTypeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FingerprintUncheckedUpdateManyWithoutFingerTypeNestedInputObjectSchema =
  Schema;
