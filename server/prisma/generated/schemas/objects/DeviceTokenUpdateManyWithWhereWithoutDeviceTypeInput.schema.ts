...
const Schema: z.ZodType<Prisma.DeviceTokenUpdateManyWithWhereWithoutDeviceTypeInput> =
  z
    .object({
...
export const DeviceTokenUpdateManyWithWhereWithoutDeviceTypeInputObjectSchema =
  Schema;
