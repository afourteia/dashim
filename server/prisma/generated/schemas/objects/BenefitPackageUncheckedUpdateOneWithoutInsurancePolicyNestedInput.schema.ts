...
const Schema: z.ZodType<Prisma.BenefitPackageUncheckedUpdateOneWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BenefitPackageUncheckedUpdateOneWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
