...
const Schema: z.ZodType<Prisma.SubscriberGroupUncheckedUpdateWithoutIdCardInput> =
  z
    .object({
      id: z
        .union([
...
export const SubscriberGroupUncheckedUpdateWithoutIdCardInputObjectSchema =
  Schema;
