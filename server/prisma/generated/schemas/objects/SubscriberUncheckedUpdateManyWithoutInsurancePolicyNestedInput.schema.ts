...
const Schema: z.ZodType<Prisma.SubscriberUncheckedUpdateManyWithoutInsurancePolicyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubscriberUncheckedUpdateManyWithoutInsurancePolicyNestedInputObjectSchema =
  Schema;
