...
const Relationship = {
  getMany: middleware(async function getMany(params?: Prisma.RelationshipFindManyArgs) {
    return await prisma.relationship.findMany(params)
  }),

  getOne: middleware(async function getOne(params: Prisma.RelationshipFindUniqueArgs) {
