...
const BenefitPackage = {
  getMany: middleware(async function getMany(params?: Prisma.BenefitPackageFindManyArgs) {
    return await prisma.benefitPackage.findMany(params)
  }),

  getOne: middleware(async function getOne(params: Prisma.BenefitPackageFindUniqueArgs) {
